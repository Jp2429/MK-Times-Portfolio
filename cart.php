...
if (!empty($_SESSION['cart']))
{
  ...
  echo '<section class="h-100 h-custom" style="background-color: #d3d3d3; padding: 20px; margin: 20px; min-height: 100vh;">
  ...
  echo '        </div> <!-- closing .p-5 for cart items -->
            ...
            <div class="col-lg-4 bg-grey">
                <div class="p-5">
                  ...
                  <a href="checkout.php?total='.$total.'" class="btn btn-primary btn-block mt-2">CHECKOUT : &pound'.number_format($total,2).'</a>
